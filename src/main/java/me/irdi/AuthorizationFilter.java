...
public class AuthorizationFilter extends OncePerRequestFilter {
    ...
    public AuthorizationFilter() {
        ...
        jwtConsumer = new JwtConsumerBuilder()
                .setRequireExpirationTime() // validate the token's expiration time
                .setEnableRequireIntegrity() // validate that the token is signed or encrypted
                .setSkipDefaultAudienceValidation() // do not validate the audience (client_id, usually)
    ...
    private void invalidTokenError(HttpServletResponse response, String errorDescription) throws IOException {
        ...
        LOGGER.warn("Rejected access with the following error description: " + errorDescription);
    }
